    ...
    <div className="">
      <div className="flex justify-center">
        <div className="w-1/2 flex justify-between">
          <div className="flex items-center">
            <div>
              <Image src="/assets/logo.webp" width={50} height={50} />
            </div>
      ...
      <div className="mt-12">
        <div className="flex w-1/2 mx-auto">
          ...
          <div className=" w-1/2 text-mainColor-100 pl-4 text-justify tracking-wide space-y-4">
            ...
            <ul>
              ...
              <li>
                • Mesh-Texture Digitization Service (Paid like dividends every 3
                months)
              </li>
            </ul>
          </div>
