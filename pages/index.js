...
export default function Home() {
  return (
    <div className=" flex flex-col justify-between h-screen">
      <div>
        ...
        <div className="mt-12">
          <div className="flex w-3/4 mx-auto">
            ...
            <div className=" w-1/2 text-mainColor-100 pl-6 text-justify tracking-wide space-y-6">
              <div className="">
                ...
                <p>
                  ...
                  Founder of the first Historic Metaverse Museum rewards you
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    • Mesh-Texture Digitization Service (Paid like dividends
                    every 3 months)
                  </li>
                </ul>
              </div>
      ...
      <footer className=" bg-white   dark:bg-gray-800 w-3/4 mx-auto m-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://www.thebitmuseum.com/" className="flex items-center">
              <Image
                src="/assets/logo.png"
                width={30}
                height={30}
                objectFit="cover"
              />
              <span className="tracking-wider font-bold text-mainColor-100">
                The Bit Museum
              </span>
            </a>
          </div>
